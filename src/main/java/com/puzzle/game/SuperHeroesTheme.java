/**
* The SuperHeroesTheme class implements FightClubTheme which
* contains options to explore the SuperHeroes theme 
*
* @author  Dutt Saladi
* @version 1.0
*/
...
public class SuperHeroesTheme implements FightClubTheme {
	...
	public SuperHeroesTheme(Fighter fighter, Fighter opponent) {
		myFighter = fighter;
	...
	public void exploreOptions() {
		...
		case YES:
			...
			for (SuperHeroesFighter fighter : SuperHeroesFighter.values())
	...
	public void chooseOpponent() {
		...
		SuperHeroesFighter selectedOpponent = consoleUtil.getSuperHeroFighter();
	...
	private void attack() {
		...
		case SAVE:
			gameOperations.saveGame(myFighter, opponentFighter, GameTheme.SUPERHERO.toString());
